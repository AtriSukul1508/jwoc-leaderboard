...
const TopCard = ({ userData }: { userData: TableDataType }) => {
  ...
  return (
    <div className="relative m-auto p-2 w-full flex justify-center align-center flex-col bg-[rgba(49,49,49,0.5)] backdrop-blur-lg shadow-[0_0_4px_rgba(50,69,107,0.2)] rounded-[6px] z-[1] overflow-hidden">
      <div className="m-auto w-full flex justify-center align-center flex-col bg-[#103662] rounded-[6px]">
        ...
        <span className="-mt-[2px] mb-2.5 mx-auto px-5 py-1 text-xl font-medium font-codefont text-black bg-darkwhite text-center tracking-[0.2px] rounded-[4px]">
          Rank: {userData?.rank}
        </span>
      </div>
      ...
      <div className="flex flex-col items-center mt-4">
        ...
        <p className="my-2 mx-auto text-lg font-medium font-mainfont text-white text-center italic tracking-[0.2px] lg:text-base">
          {userData?.college}
        </p>
        <button
          onClick={() => {
